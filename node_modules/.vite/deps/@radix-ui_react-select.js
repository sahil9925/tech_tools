...
import {
  ...
  useId,
  useLayoutEffect2
} from "./chunk-EQ545K7G.js";
import {
  Primitive,
  dispatchDiscreteCustomEvent
} from "./chunk-3XYMCQLG.js";
import {
  require_react_dom
...
var DismissableLayerBranch = React2.forwardRef(__name3(function DismissableLayerBranch2(props, forwardedRef) {
  const context = React2.useContext(DismissableLayerContext);
...
var PopperArrow = React8.forwardRef(
...
__name10(usePrevious, "usePrevious");
...
function SelectProvider(props) {
  ...
  const initialValueRef = React21.useRef(value);
  React21.useEffect(() => {
    ...
    if (associatedForm instanceof HTMLFormElement) {
      const reset = __name12(() => setValue(initialValueRef.current), "reset");
...
__name12(SelectProvider, "SelectProvider");
var Select = __name12((props) => {
...
var SelectTrigger = React21.forwardRef(
  __name12(function SelectTrigger2(props, forwardedRef) {
    ...
    const handleOpen = __name12((pointerEvent) => {
      if (!isDisabled) {
...
var SelectValue = React21.forwardRef(
  __name12(function SelectValue2(props, forwardedRef) {
...
var SelectIcon = React21.forwardRef(
  __name12(function SelectIcon2(props, forwardedRef) {
...
var SelectPortal = __name12((props) => {
...
var SelectContent = React21.forwardRef(
  __name12(function SelectContent2(props, forwardedRef) {
...
var SelectContentFragment = React21.forwardRef(__name12(function SelectContentFragment2(props, forwardedRef) {
...
var SelectContentImpl = React21.forwardRef(
  // blank line to reduce diff noise
  __name12(function SelectContentImpl2(props, forwardedRef) {
    ...
    React21.useEffect(() => {
      if (content) {
        ...
        const handlePointerMove = __name12((event) => {
          var _a, _b;
          pointerMoveDelta = {
        ...
        const handlePointerUp = __name12((event) => {
    ...
    React21.useEffect(() => {
      const close = __name12(() => onOpenChange(false), "close");
...
var SelectItemAlignedPosition = React21.forwardRef(__name12(function SelectItemAlignedPosition2(props, forwardedRef) {
...
var SelectPopperPosition = React21.forwardRef(__name12(function SelectPopperPosition2(props, forwardedRef) {
  const {
    __scopeSelect,
    align = "start",
...
var SelectViewport = React21.forwardRef(
  __name12(function SelectViewport2(props, forwardedRef) {
...
var SelectGroup = React21.forwardRef(
  __name12(function SelectGroup2(props, forwardedRef) {
...
var SelectLabel = React21.forwardRef(
  __name12(function SelectLabel2(props, forwardedRef) {
...
var SelectItem = React21.forwardRef(
  __name12(function SelectItem2(props, forwardedRef) {
    const {
      __scopeSelect,
      value,
      disabled = false,
...
var SelectItemText = React21.forwardRef(
  __name12(function SelectItemText2(props, forwardedRef) {
...
var SelectItemIndicator = React21.forwardRef(
  // blank line to reduce diff noise
  __name12(function SelectItemIndicator2(props, forwardedRef) {
...
var SelectScrollUpButton = React21.forwardRef(__name12(function SelectScrollUpButton2(props, forwardedRef) {
  ...
  useLayoutEffect2(() => {
    if (contentContext.viewport && contentContext.isPositioned) {
      ...
      __name12(handleScroll22, "handleScroll");
...
var SelectScrollDownButton = React21.forwardRef(__name12(function SelectScrollDownButton2(props, forwardedRef) {
...
var SelectScrollButtonImpl = React21.forwardRef(__name12(function SelectScrollButtonImpl2(props, forwardedRef) {
...
var SelectSeparator = React21.forwardRef(
  // blank line to reduce diff noise
  __name12(function SelectSeparator2(props, forwardedRef) {
...
var SelectArrow = React21.forwardRef(
  __name12(function SelectArrow2(props, forwardedRef) {
...
var SelectBubbleInput = React21.forwardRef(
  // blank line to reduce diff noise
  __name12(function SelectBubbleInput2({ __scopeSelect, ...props }, forwardedRef) {
...
__name12(shouldShowPlaceholder, "shouldShowPlaceholder");
function useTypeaheadSearch(onSearchChange) {
  ...
  const handleTypeaheadSearch = React21.useCallback(
    (key) => {
      ...
      __name12(function updateSearch(value) {
...
__name12(useTypeaheadSearch, "useTypeaheadSearch");
...
__name12(findNextItem, "findNextItem");
function wrapArray(array, startIndex) {
  return array.map((_, index2) => array[(startIndex + index2) % array.length]);
}
__name12(wrapArray, "wrapArray");
export {
